...
class RunMetricsWrapper<T> implements Callable<T>, Runnable {
    ...
    public T call() throws Exception {
        ...
        ScheduledFuture<?> future = longTaskMonitor.scheduleAtFixedRate(new LongTaskDetector(this), 
                Long.getLong("edu.uci.ics.luci.p2p4java.impl.util.threads.RunMetricsWrapper.delay",1L), 
                Long.getLong("edu.uci.ics.luci.p2p4java.impl.util.threads.RunMetricsWrapper.interval",20L),
                TimeUnit.SECONDS);
